...
tags: [ai, non-tech]
atUri: "at://did:plc:a5mekodp4afxadlpr4hp2wci/site.standard.document/3mm2oewebsg2l"
---
...
So who trained it? A lot of the early training, data annotations and other manual processes, happened with [cheap labour in African countries](https://data-workers.org/wp-content/uploads/2025/12/The-Emotional-Labor-Behind-AI-Intimacy-1.pdf). There are multiple sources that have revealed the hidden [economy of workers that big-tech outsources these kinds of tasks to African countries with unstable political situations, weaker workers rights, and cheap labour](https://restofworld.org/2025/big-tech-ai-labor-supply-chain-african-workers/).   
## How do I know AI adapted their styles? I will tell you.[^4]   
You see, I am Nigerian, and [we are known for our flowery, flamboyant, and persuasory style of speaking and writing](https://www.bbc.com/news/world-africa-38827888). It is very likely that this is a trait from our traditional languages that filtered into our use of English language.   
I remember [Paul Graham saying that "delve" is an indicator that an email was composed with AI](https://www.businessinsider.com/y-combinator-paul-graham-delve-ai-chatgpt-giveaway-email-pitch-2024-4).

*Delve* is a staple word in Nigeria. This word has been around all my life - from primary school, it's like an everyday word. And you can see how Nigerians reacted to Paul Graham's assertion. [Their reactions on Twitter](https://x.com/search?q=paul%20graham%20delve) *resonate* with me.
...
I think [it is clear that the stylistic choices of these AIs are influenced heavily from the stylistic choices of the people that big tech contracted to do the training](https://www.theguardian.com/technology/2024/apr/16/techscape-ai-gadgest-humane-ai-pin-chatgpt).   
   
## AI Detection Tools Are Unreliable   
Any AI detector that tells you it can reliably detect AI usage in text is very likely lying to you. Even [OpenAI's detector was shut down because it was not found to be reliable.](https://decrypt.co/149826/openai-quietly-shutters-its-ai-detection-tool)

[MIT also affirmed that AI detectors simply do not work](https://mitsloanedtech.mit.edu/ai/teach/ai-detectors-dont-work/). We should be thinking of how to evolve our pedagogic processes, rather than trying to sniff out who is using AI or not.   
...
As found out in [this study from Stanford](https://hai.stanford.edu/news/ai-detectors-biased-against-non-native-english-writers), non-native English speakers are more likely to be accused of using AI ([full study is here](https://arxiv.org/pdf/2304.02819)),  because of a combination of the reasons I have highlighted in this essay and it all feels like a round of punishment.
...
## Footnotes   
[^1]: [Antithesis](https://www.buckleyschool.com/magazine/articles/rhetorical-device-of-the-month-antithesis/) - contrary to multiple claims, humans do in fact, use antithesis as a rhetorical device.   
[^2]: [Em-dash](https://www.merriam-webster.com/grammar/em-dash-en-dash-how-to-use). I will not stop using this. Call me AI all you want.
[^3]: [AP style title case](https://apastyle.apa.org/style-grammar-guidelines/capitalization/title-case). This is an age-old writing style that has been in existence in academic and journalistic writing. [Wikipedia claims it's a sign of undisclosed AI usage](https://en.wikipedia.org/wiki/Wikipedia:Signs_of_AI_writing#Title_case), and I strongly and vehemently disagree.   
[^4]: [Rhetorical question](https://www.bbc.co.uk/bitesize/articles/z7dyvk7). People also claim that using rhetorical questions is a sign of undisclosed AI usage, and again, I adamantly disagree.   
[^5]: [Diectic expression](https://www.thoughtco.com/deictic-expression-deixis-1690428). Sort of using vague non-descriptive words that require context to fill in.
